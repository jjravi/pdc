...
int main(int argc, char **argv)
{
    ...
    ///////////////////////////////////////////////////////
    // struct _pdc_id_info *obj1_id_info = (struct _pdc_id_info *)PDC_find_id(obj1);
    // struct _pdc_obj_info *obj1_obj_info = (struct _pdc_obj_info *)(obj1_id_info->obj_ptr);
    // struct _pdc_obj_info *obj1_obj_info = PDC_obj_get_info(obj1);
    struct _pdc_obj_info *obj1_obj_info = PDC_obj_get_info(i_iter->objectId);
    struct pdc_obj_info *obj1_info_pub = obj1_obj_info->obj_info_pub;
    struct pdc_obj_prop *obj1_pt = obj1_info_pub->obj_pt;
    printf("%lu, %ld, (%lux%lu), %d, %d, %d\n", 
      obj1_pt->obj_prop_id, obj1_pt->ndim, obj1_pt->dims[0], obj1_pt->dims[1],
      obj1_pt->type, obj1_pt->region_partition, obj1_pt->consistency);

    // struct _pdc_id_info * obj2_id_info = (struct _pdc_id_info *)PDC_find_id(obj2);
    // struct _pdc_obj_info *obj2_obj_info = (struct _pdc_obj_info *)(obj2_id_info->obj_ptr);
    // struct _pdc_obj_info *obj2_obj_info = PDC_obj_get_info(obj2);
    struct _pdc_obj_info *obj2_obj_info = PDC_obj_get_info(o_iter->objectId);
    struct pdc_obj_info *obj2_info_pub = obj2_obj_info->obj_info_pub;
    struct pdc_obj_prop *obj2_pt = obj2_info_pub->obj_pt;
    printf("%lu, %ld, (%lux%lu), %d, %d, %d\n", 
      obj2_pt->obj_prop_id, obj2_pt->ndim, obj2_pt->dims[0], obj2_pt->dims[1],
      obj2_pt->type, obj2_pt->region_partition, obj2_pt->consistency);
...
//  Simple test of invoking a function dynamically
    ...
    ret = PDCreg_obtain_lock(obj1, r1, PDC_WRITE, PDC_NOBLOCK);
    ret = PDCreg_release_lock(obj1, r1, PDC_WRITE);

    {
      ...
      if ((blockLengthOut = PDCobj_data_getNextBlock(result1_iter, (void **)&dataOut, NULL)) > 0) {
        while ((blockLengthIn = PDCobj_data_getNextBlock(input1_iter, (void **)&dataIn, NULL)) > 0) {
